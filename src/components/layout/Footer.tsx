        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-socials">
              <a href="https://www.instagram.com/taisa.studio/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer-social">
          ...
          <div>
            ...
            <ul className="footer-links">
              <li>
                <a href="tel:+5511987654321" className="footer-link footer-contact-item">
              ...
              <li>
                <a href="mailto:contato@taisa.com.br" className="footer-link footer-contact-item">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                    <polyline points="22,6 12,13 2,6"/>
                  </svg>
                  contato@taisa.com.br
                </a>
              </li>
              <li>
